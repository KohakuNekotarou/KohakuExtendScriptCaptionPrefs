...
DECLARE_PMID(kScriptInfoIDSpace, kKESCPCaptionParagraphStyleIDPropertyScriptElement, kKESCPPrefix + 3)
...
DECLARE_PMID(kScriptInfoIDSpace, kKESCPBeforeStringPropertyScriptElement, kKESCPPrefix + 10)
